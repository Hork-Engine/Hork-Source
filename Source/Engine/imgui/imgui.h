...
struct ImDrawCmd
{
    ...
    ImDrawCmd() { ElemCount = 0; ClipRect.x = ClipRect.y = ClipRect.z = ClipRect.w = 0.0f; TextureId = (ImTextureID)NULL; UserCallback = NULL; UserCallbackData = NULL; BlendingState = 0; }
};
...
struct ImDrawList
{
    ...
    ImVector<int>           _BlendingStack;     // [Internal]
    ...
    ImDrawList(const ImDrawListSharedData* shared_data=NULL) { _Data = shared_data; _OwnerName = NULL; Clear(); }
    ...
    IMGUI_API void  PushBlendingState(int blending);
    IMGUI_API void  PopBlendingState();
    ...
    IMGUI_API void  AddImage(ImTextureID user_texture_id, const ImVec2& a, const ImVec2& b, const ImVec2& uv_a = ImVec2(0,0), const ImVec2& uv_b = ImVec2(1,1), ImU32 col = 0xFFFFFFFF, int blend = 0 );
    IMGUI_API void  AddImageQuad(ImTextureID user_texture_id, const ImVec2& a, const ImVec2& b, const ImVec2& c, const ImVec2& d, const ImVec2& uv_a = ImVec2(0,0), const ImVec2& uv_b = ImVec2(1,0), const ImVec2& uv_c = ImVec2(1,1), const ImVec2& uv_d = ImVec2(0,1), ImU32 col = 0xFFFFFFFF, int blend = 0);
    IMGUI_API void  AddImageRounded(ImTextureID user_texture_id, const ImVec2& a, const ImVec2& b, const ImVec2& uv_a, const ImVec2& uv_b, ImU32 col, float rounding, int rounding_corners = ImDrawCornerFlags_All, int blend = 0);
    ...
    IMGUI_API void  AddCallbackMY(ImDrawCallback callback, void* callback_data);
    ...
    IMGUI_API void  UpdateBlendingState();
};
...
struct ImFontAtlas
{
    ...
    IMGUI_API static const ImWchar*    GetGlyphRangesVietnamese();             // Default + Vietname characters
...
struct ImFont
{
    ...
    IMGUI_API SWideChar const * CalcWordWrapPositionW( float scale, SWideChar const * text, SWideChar const * text_end, float wrap_width ) const;
