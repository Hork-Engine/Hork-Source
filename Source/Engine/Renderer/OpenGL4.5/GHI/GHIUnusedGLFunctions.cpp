...
#endif
//void SetFramebufferSRGB( bool _EnableSRGB ) {
//    // If enabled and the value of GL_FRAMEBUFFER_ATTACHMENT_COLOR_ENCODING for the framebuffer
//    // attachment corresponding to the destination buffer is GL_SRGB, the R, G, and B destination
...
//GHI_Framebuffer_t * GetDefaultFramebuffer( GHI_State_t * _State ) {
//    static GHI_Framebuffer_t * pDefaultFB = NULL;
//    static GHI_Framebuffer_t defaultFB;
//    if ( !pDefaultFB ) {
//        defaultFB.HardwareResource = GL_RESOURCE_FROM_HANDLER( 0 );
//        pDefaultFB = &defaultFB;
//    }
//    return pDefaultFB;
//}

//bool IsDefaultFramebuffer( const GHI_Framebuffer_t * _Framebuffer ) {
//    return GL_HANDLER_FROM_RESOURCE( _Framebuffer ) == 0;
//}
...
//        glTextureStorage3D( id, 1, GL_RG32UI, 8, 8, 8 );
//        glPixelStorei( GL_UNPACK_ALIGNMENT, 1 );
//
//        uint32_t data[ 8*8*8*2 ];
//        memset( data, 0xff, sizeof( data ) );
//        //for ( int i = 0 ; i < 8 ; i++ ) {
//        //    glTextureSubImage3D( id, 0, 0, 0, i, 8, 8, 1, GL_RG32UI, GL_UNSIGNED_INT, data );
//        //}
//        glTextureSubImage3D( id, 0, 0, 0, 0, 8, 8, 8, GL_RG_INTEGER, GL_UNSIGNED_INT, data );
//
